...
namespace dotmob
{
	public class MobileAdsSettings : SingletonScriptableObject<MobileAdsSettings>
	{
		...
		public class AdMobConfig
		{
			...
			public string				AppId					{ get { return ReturnPlatformValue(androidConfig.appId, iosConfig.appId); } }
			public string				BannerPlacementId		{ get { return ReturnPlatformValue(androidConfig.bannerUnitId, iosConfig.bannerUnitId); } }
			public string				InterstitialPlacementId	{ get { return ReturnPlatformValue(androidConfig.interstitialUnitId, iosConfig.interstitialUnitId); } }
			public string				RewardPlacementId		{ get { return ReturnPlatformValue(androidConfig.rewardUnitId, iosConfig.rewardUnitId); } }
